...
var WorkoutContainerCompnent = (function () {
    function WorkoutContainerCompnent(route, router) {
        this.route = route;
        this.router = router;
    }
    WorkoutContainerCompnent.prototype.ngOnInit = function () {
        var _this = this;
        this.sub = this.route.params.subscribe(function (params) {
            _this.workoutName = params['id'];
        });
    };
    WorkoutContainerCompnent.prototype.ngOnDestroy = function () {
        this.sub.unsubscribe();
    };
    WorkoutContainerCompnent = __decorate([
        core_1.Component({
    ...
    return WorkoutContainerCompnent;
    var _a, _b;
}());
exports.WorkoutContainerCompnent = WorkoutContainerCompnent;
